      ...
      <header className="bg-slate-900/80 backdrop-blur-sm border-b border-slate-700">
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-4">
              <span className="text-white">Driver Portal</span>
              <Button
                onClick={() => setIsOnline(!isOnline)}
                className={`${isOnline ? 'bg-green-500 hover:bg-green-600' : 'bg-red-500 hover:bg-red-600'} text-white`}
              >
                ...
                <Card key={delivery.id} className="bg-slate-800/50 border-slate-700">
                  <CardContent className="p-6">
                    <div className="flex items-start justify-between mb-4">
                      <div>
                        <h3 className="text-xl font-semibold text-white mb-1">{delivery.shopName}</h3>
                    ...
                    <div className="mb-4">
                      ...
                      <p className="text-white">{delivery.buyerAddress}</p>
                    </div>
              ...
              {availableRequests.map((request) => (
                <Card key={request.id} className="bg-slate-800/50 border-slate-700 hover:bg-slate-700/50 transition-colors">
                  <CardContent className="p-6">
                    <div className="flex items-start justify-between mb-4">
                      <div>
                        <h3 className="text-xl font-semibold text-white mb-1">{request.shopName}</h3>
                    ...
                    <div className="mb-4">
                      ...
                      <p className="text-white">{request.buyerAddress}</p>
